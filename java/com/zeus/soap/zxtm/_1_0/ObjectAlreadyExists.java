...
/**
 * The ObjectAlreadyExists fault is raised when attempting to create
 * an
 *              object (such as a Virtual Server) that already exists.
 * It will also
 *              be raised in cases such as renaming and copying objects.
 */
public class ObjectAlreadyExists  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    /**
     * Gets the errmsg value for this ObjectAlreadyExists.
     * 
    ...
    /**
     * Sets the errmsg value for this ObjectAlreadyExists.
     * 
    ...
    /**
     * Gets the object value for this ObjectAlreadyExists.
     * 
    ...
    /**
     * Sets the object value for this ObjectAlreadyExists.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ObjectAlreadyExists)) return false;
        ObjectAlreadyExists other = (ObjectAlreadyExists) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ObjectAlreadyExists.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://soap.zeus.com/zxtm/1.0/", "ObjectAlreadyExists"));
